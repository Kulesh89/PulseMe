...
class PULSE(torch.nn.Module):
    def __init__(self, cache_dir, verbose=True):
        ...
        with open_url("https://autopijon.com.ua/synthesis.pt", cache_dir=cache_dir, verbose=verbose) as f:
        ...
        if Path("gaussian_fit.pt").exists():
            ...
            with open_url("https://autopijon.com.ua/mapping.pt", cache_dir=cache_dir, verbose=verbose) as f:
